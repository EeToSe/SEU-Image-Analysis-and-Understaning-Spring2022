...
# Top-hat transform
I0 = cv.imread("image_analysis/data/ass1/ass1-2/rice.png", cv.IMREAD_GRAYSCALE)
I0_th = I0.copy()
I0_th[I0_th <= 150] = 0
I0_th[I0_th > 150] = 255

# compute I_top-hat
se1 =  np.loadtxt("image_analysis/data/ass1/ass1-2/se_1.txt", delimiter=",").astype(np.uint8)
...
se2 = np.loadtxt("image_analysis/data/ass1/ass1-2/se_2.txt", delimiter=",").astype(np.uint8)
